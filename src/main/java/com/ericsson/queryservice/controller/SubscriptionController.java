...
public interface SubscriptionController {
    ...
    public ResponseEntity<List<com.ericsson.queryservice.controller.model.Subscription>> getSubscriptions();
    ...
    public ResponseEntity<?> createSubscription(
        ...
        com.ericsson.queryservice.controller.model.Subscription subscription);
    ...
    public ResponseEntity<com.ericsson.queryservice.controller.model.SubscriptionResponse> updateSubscriptions(
        @javax.validation.Valid
        @org.springframework.web.bind.annotation.RequestBody
        com.ericsson.queryservice.controller.model.Subscription subscription);
    ...
    public ResponseEntity<com.ericsson.queryservice.controller.model.Subscription> getSubscriptionById(
        @PathVariable
    ...
    public ResponseEntity<com.ericsson.queryservice.controller.model.SubscriptionResponse> deleteSubscriptionById(
        @PathVariable
        String subscriptionName);
