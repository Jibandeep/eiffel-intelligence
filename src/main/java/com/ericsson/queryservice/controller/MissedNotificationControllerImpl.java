...
import com.ericsson.queryservice.ProcessMissedNotification;
...
public class MissedNotificationControllerImpl implements MissedNotificationController {
    ...
    public ResponseEntity<QueryResponse> getQueryMissedNotifications(
        ...
        ArrayList<String> response = processMissedNotification.processQueryMissedNotification(subscriptionName);
